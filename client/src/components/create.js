...
export default function Create() {
  ...
  // updating state properties method
  ...
  async function onSubmit(e) {
    ...
    // when a post request is sent to the database, we add a record to the database
  ...
  // Form will be displayed in this section
  return (
    <div>
      ...
      <form onSubmit={onSubmit}>
        ...
        <div className="form-group">
          <div className="form-check form-check-inline">
            ...
            />
            <label htmlFor="positionIntern">PositionIntern</label>
          </div>
